...
- **NativeAOT-ready** — designed for AOT-published deployment. Measured ~118ms cold-start init duration on AWS Lambda at 512 MB. See the [AotLambda sample](https://github.com/apncodes/StrandsAgents.net/tree/main/samples/AotLambda).
